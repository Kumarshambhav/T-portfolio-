...
const DATA = {
  ...
  projects: [
    {
      name: "PixelMist",
      desc: "Designed and developed a full-stack tweet only text, filtering, and contacting listings with real-time responsiveness. Built with MERN, JWT auth",
      tags: ["MERN", "Maps", "JWT", "Tailwind"]
    },
    {
      name: "Real Estate Platform",
      desc: "Designed and developed a full-stack real estate platform enabling browsing, filtering, and contacting listings with real-time responsiveness. Built with MERN, JWT auth, interactive map views, and admin panel.",
      tags: ["MERN", "Maps", "JWT", "Tailwind"]
    },
    {
      name: "Smart Home Automation",
      desc: "System that controls appliances using IoT sensors and real-time data. Implemented energy monitoring and ML-based consumption prediction.",
      tags: ["Python", "IoT", "ML"]
    },
    {
      name: "StartUpNest — Co-Living Platform",
      desc: "A platform to filter rooms and rank hostels based on startup performance, featuring real-time updates of active projects.",
      tags: ["React", "Realtime", "Tailwind"]
    },
    {
      name: "CodeReview (GenAI Integration)",
      desc: "Frontend that communicates with Gemini API for real-time code analysis, automating detection of bugs and smells and improving developer workflows.",
      ...
      <Html distanceFactor={6} className="pointer-events-none">
        <div
          className={clsx(
            ...
            isDark ? "bg-white/8 text-white" : "bg-black/6 text-black"
          )}
        >
          {skill.name}
        </div>
